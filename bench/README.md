...
`compare.sh` builds both implementations, starts the same deterministic local
upstream, and sends identical HTTP/1.1 workloads through each proxy. It reports
